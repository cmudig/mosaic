...
data = vg.data(
    rides=vg.parquet("https://pub-1da360b43ceb401c809f68ca37c7f8a4.r2.dev/data/nyc-rides-2010.parquet", select=["pickup_datetime::TIMESTAMP AS datetime", "ST_Transform(ST_Point(pickup_latitude, pickup_longitude), 'EPSG:4326', 'ESRI:102718') AS pick", "ST_Transform(ST_Point(dropoff_latitude, dropoff_longitude), 'EPSG:4326', 'ESRI:102718') AS drop"]),
...
view = vg.vconcat(
    ...
    vg.vspace(10),
    vg.plot(
        vg.rect_y(data="trips", x=vg.bin("time"), y=vg.count(), fill="steelblue", inset=0.5),
...
spec = vg.spec(meta, data, view, config={
    "extensions": "spatial"
})