...
view = vg.plot(
    ...
    vg.text(data="endpoint", x="date", y="previous", text=["2019"], fill_opacity=0.5, line_anchor="bottom", dy=-6),
    vg.text(data="endpoint", x="date", y="current", text=["2020"], line_anchor="top", dy=6),
    vg.y_grid(True),
