...
view = vg.plot(
    ...
    vg.dot(data="bls_unemp", x="date", y="unemployment", z="division", r=2, fill="currentColor", select="nearestX"),
    vg.text(data="bls_unemp", x="date", y="unemployment", text="division", fill="currentColor", dy=-8, select="nearestX"),
    vg.margin_left(24),
    vg.x_label(None),
    vg.x_ticks(10),
