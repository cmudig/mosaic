...
view = vg.hconcat(
    vg.vconcat(
        vg.plot(
            vg.raster(data="gaia", filter_by=brush, x="u", y="v", fill="density", bandwidth=bandwidth, pixel_size=pixelSize),
        ...
        vg.hconcat(
            vg.plot(
                vg.rect_y(data="gaia", filter_by=brush, x=vg.bin("phot_g_mean_mag"), y=vg.count(), fill="steelblue", inset=0.5),
            ...
            vg.plot(
                vg.rect_y(data="gaia", filter_by=brush, x=vg.bin("parallax"), y=vg.count(), fill="steelblue", inset=0.5),
                vg.interval_x(bind=brush),
                vg.x_domain("Fixed"),
                vg.y_scale(scaleType),
                vg.y_grid(True),
    ...
    vg.hspace(10),
    vg.plot(
        vg.raster(data="gaia", filter_by=brush, x="bp_rp", y="phot_g_mean_mag", fill="density", bandwidth=bandwidth, pixel_size=pixelSize),
        vg.interval_xy(pixel_size=2, bind=brush),
        vg.xy_domain("Fixed"),
        vg.color_scale(scaleType),
        vg.color_scheme("viridis"),
